jQuery(document).ready(function($){
    ...
    $('li', '#menu').hover(
        function(){
            ...
            $('span', ul).css('color', 'rgb(112,112,112)');
            if (ul.length){
                if (!ul[0].wid){
                    ul[0].wid = ul.width();
                    ul[0].hei = ul.height();
    ...
    if (!($.browser.msie && $.browser.version.substr(0, 1) == '6')){
        $('ul ul a span', '#menu').css('color', 'rgb(112,112,112)').hover(
            function(){ $(this).animate({color: 'rgb(25,153,5)'}, 500); },
            function(){ $(this).animate({color: 'rgb(112,112,112)'}, 200); }
        );
    }
